...
impl InstanceId {
    pub fn new(replica_id: ReplicaId, local_instance_id: LocalInstanceId) -> Self {
        Self(replica_id, local_instance_id)
    }
}
...
impl Ballot {
    pub fn new(round: Round, replica_id: ReplicaId) -> Self {
        Self(round, replica_id)
    }
}
...
impl fmt::Debug for InstanceId {
    ...
    fn fmt(&self, f: &mut fmt::Formatter<'_>) -> fmt::Result {
        f.debug_tuple("InstanceId")
            .field(&self.0.raw_value())
            .field(&self.1.raw_value())
            .finish()
    }
}
