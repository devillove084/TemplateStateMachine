...
use protocol::rpc::{RpcClientConfig, RpcServerConfig};
...
impl Default for NetworkConfig {
    fn default() -> Self {
        Self { inbound_chan_size: 1024, outbound_chan_size: 1024, initial_reconnect_timeout_us: 1000, max_reconnect_timeout_us: 1000, max_frame_length: 1024 }
    }
}
